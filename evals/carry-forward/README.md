...
The server contract and one-repair behavior live in `api/compile-task.test.ts`. A live model smoke test is intentionally separate because it depends on project quota and network availability.
